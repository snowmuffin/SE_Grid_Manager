...
namespace TorchPlugin
{
    public class Commands : CommandModule
    {
        ...
        [Command("cmd help", "Gridmanager: Help")]
        ...
        // ReSharper disable once UnusedMember.Global
        [Command("cmd info", "Gridmanager: Prints the current settings")]
        [Permission(MyPromoteLevel.None)]
        public void Info()
        {
            RespondWithInfo();
        ...
        // ReSharper disable once UnusedMember.Global
        [Command("cmd enable", "Gridmanager: Enables the plugin")]
        ...
        // ReSharper disable once UnusedMember.Global
        [Command("cmd disable", "Gridmanager: Disables the plugin")]
        [Permission(MyPromoteLevel.Admin)]
        public void Disable()
        {
        ...
        // TODO: Subcommand
        // ReSharper disable once UnusedMember.Global
        [Command("cmd subcmd", "Gridmanager: TODO: Subcommand")]
        [Permission(MyPromoteLevel.Admin)]
